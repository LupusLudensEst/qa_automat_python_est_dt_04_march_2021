# hw_3_classes_if_for_dt_23_march_2021
...
print(f"1. Write function for list of integers (create own) which returns list but with each element's index added to the itself.\n"
...
class ClassName:
    ...
    def __init__(self, first_name, last_name, full_name, initials):
...
object_1 = ClassName(first_name, last_name, full_name, initials)
